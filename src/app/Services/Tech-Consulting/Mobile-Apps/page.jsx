  ...
  const benefits = [
    {
      ...
      description: "Accelerate your app development process with our efficient methodologies."
    },
    {
      icon: <FiShield className="text-3xl" />,
      title: "Robust Security",
      description: "Implement top-notch security measures to protect user data and privacy."
    },
    {
      icon: <FiTrendingUp className="text-3xl" />,
      title: "Scalable Solutions",
      description: "Build apps that can grow with your business and handle increasing user loads."
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "We gather and analyze your requirements to create a tailored app strategy."
    },
    {
      step: "02", 
      title: "Design & Prototyping",
      description: "Create intuitive designs and prototypes to visualize the app's user experience."
    },
    {
      step: "03",
      title: "Development & Testing",
      description: "Develop the app with rigorous testing to ensure functionality and performance."
    },
    {
      step: "04",
      title: "Launch & Support",
      description: "Launch your app on app stores and provide ongoing support and updates."
    }
  ];

  const techStack = [
    "React Native", "Flutter", "Swift", "Kotlin", "Node.js", 
    "Firebase", "REST APIs", "GraphQL", "SQLite", "Xcode"
  ];
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-green-100 mt-2">Innovative Mobile Solutions</p>
                </div>
              </div>
              
              <p className="text-lg mb-8 leading-relaxed opacity-90">
                Transform your ideas into reality with our expert mobile app development services. We create user-friendly, secure, and scalable mobile applications that enhance user engagement and drive business growth.
              </p>
      ...
      <section className="bg-white py-12 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            {[
              { number: "300+", label: "Apps Developed" },
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <p className="text-gray-600 mb-8 leading-relaxed">
                    Our mobile app development services are designed to help businesses create engaging and user-friendly applications. We focus on delivering high-quality, secure, and scalable mobile solutions that meet your specific needs.
                  </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-white text-xl mb-8 leading-relaxed">
              Let's discuss your mobile app development needs and create a successful application together.
            </p>
